(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><div class="container"><div class="navbar"><div class="navbar-inner"><a href="#" class="brand">Natural Calendar</a><ul class="nav"><li><a href="/">home</a></li><li><a href="/collections">collection demo</a></li><li><a href="/info">more info</a></li></ul></div></div><main id="pages" role="page-container"></main></div></body>';
    };
    ...
    templatizer["pages"]["home"] = function tmpl_pages_home() {
        return '<section class="page home"><h2>Welcome to a skeleton for Natural Calendar</h2><p>If you "view source" you\'ll see it\'s 100% client rendered.</p><p>Click around the site using the nav bar at the top. </p><p>Things to note:<ul><li>The url changes, no requests are made to the server.</li><li>Refreshing the page will always get you back to the same page</li><li>Page changes are nearly instantaneous</li><li>In development mode, you don\'t need to restart the server to see changes, just edit and refresh.</li><li>In production mode, it will serve minfied, uniquely named files with super agressive cache headers. To test:<ul> <li>in dev_config.json set <code>isDev</code> to <code>false</code>.</li><li>restart the server.</li><li>view source and you\'ll see minified css and js files with unique names.</li><li>open the "network" tab in chrome dev tools (or something similar). You\'ll also want to make sure you haven\'t disabled your cache.</li><li>without hitting "refresh" load the app again (selecting current URL in url bar and hitting "enter" works great).</li><li>you should now see that the JS and CSS files were both served from cache without making any request to the server at all.</li></ul></li></ul></p></section>';
    };

    // pages/info.jade compiled template
    templatizer["pages"]["info"] = function tmpl_pages_info() {
        return '<section class="page pageTwo"><div class="container-fluid"><div class="row"><div id="date-text"></div><input id="date-pick" type="date" name="show-date"/><canvas id="cycles" width="500px" height="500px"></canvas><table id="moonth-grid"><tr> <td> <a id="day1">1 </a></td><td><a id="day2">2</a></td><td> <a id="day3">3 </a></td><td><a id="day4">4</a></td><td><a id="day5">5</a></td></tr><tr> <td> <a id="day6">6 </a></td><td><a id="day7">7</a></td><td> <a id="day8">8 </a></td><td><a id="day9">9</a></td><td><a id="day10">10</a></td></tr><tr> <td> <a id="day11">11 </a></td><td><a id="day12">12</a></td><td> <a id="day13">13 </a></td><td><a id="day14">14</a></td><td><a id="day15">15</a></td></tr><tr> <td> <a id="day16">16 </a></td><td><a id="day17">17</a></td><td> <a id="day18">18</a></td><td><a id="day19">19</a></td><td><a id="day20">20</a></td></tr><tr> <td> <a id="day21">21 </a></td><td><a id="day22">22</a></td><td> <a id="day23">23 </a></td><td><a id="day24">24</a></td><td><a id="day25">25</a></td></tr><tr> <td> <a id="day26">26</a></td><td><a id="day27">27</a></td><td> <a id="day28">28 </a></td><td><a id="day29">29</a></td><td><a id="day30">30</a></td></tr></table><table id="months-in-year"><tr id="moonth-row"></tr></table></div></div></section>';
    };
